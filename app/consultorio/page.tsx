      ...
      <main className="mx-auto max-w-7xl w-full px-4 py-8 sm:px-6 lg:px-8 flex-1">
        ...
        <div className="flex flex-wrap items-center justify-between gap-4 border-b border-slate-200 pb-6 mb-6">
          ...
          <div className="flex items-center gap-3">
            <Link
              href="/dossie"
              className="flex items-center gap-1.5 rounded-xl border border-slate-300 bg-white hover:bg-slate-50 px-3.5 py-2 text-xs font-semibold text-slate-700 shadow-sm transition-colors"
            >
        ...
        {/* Navigation Tabs for All Clinic Modules */}
        <div className="flex items-center gap-1.5 border-b border-slate-200 pb-3 mb-8 overflow-x-auto text-xs font-mono-tech">
          <button
            type="button"
          ...
          >
            <Scan className="h-4 w-4" />
            <span>Antropometria & 3D Óptico</span>
          </button>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
              ...
              <div className="lg:col-span-5 space-y-4">
                <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
                  <h3 className="text-base font-bold text-slate-900 mb-2">Protocolos Antropométricos Ativos</h3>
                  <div className="space-y-2 text-xs font-mono-tech">
                    <div className="p-2.5 rounded-lg bg-emerald-50/60 border border-emerald-200 flex justify-between items-center">
                      <div>
                        <strong className="text-slate-900 block">Scanner 3D Óptico</strong>
                        <span className="text-[10px] text-emerald-800">98.4% correlação com DEXA</span>
                      </div>
                    ...
                    <div className="p-2.5 rounded-lg bg-slate-50 border border-slate-200 flex justify-between items-center">
                      <div>
                        <strong className="text-slate-800 block">Jackson & Pollock 7 Dobras</strong>
                        <span className="text-[10px] text-slate-500">Plicômetro clínico tradicional</span>
                      </div>
                      <span className="text-slate-500 text-[10px]">Configurado</span>
                    </div>

                    <div className="p-2.5 rounded-lg bg-slate-50 border border-slate-200 flex justify-between items-center">
                      <div>
                        <strong className="text-slate-800 block">Bioimpedância (InBody / Tanita)</strong>
                ...
                <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
                  <h3 className="text-base font-bold text-slate-900 mb-1">Evolução do Paciente (90 Dias)</h3>
                  <div className="text-xs font-mono-tech text-slate-600 mb-4">
                    Gordura: -3.8% • Massa Magra: +1.6kg • Cintura: -5cm
                  </div>
                  <Link
                    href="/scanner"
                    className="block w-full text-center rounded-xl bg-emerald-600 hover:bg-emerald-500 py-2.5 text-xs font-semibold text-white transition-colors shadow-sm"
                  >
        ...
        {activeTab === 'prontuario' && (
          <div className="rounded-2xl border border-slate-200 bg-white p-6 sm:p-8 shadow-sm space-y-6">
            <div className="flex justify-between items-start border-b border-slate-200 pb-4">
              <div>
                <h2 className="text-xl font-bold text-slate-900">João Freire</h2>
                <div className="text-xs text-slate-500 font-mono-tech mt-0.5">
                  28 anos • Homem • Hipertrofia & Definição • Última consulta: 18/09/2026
                </div>
              </div>
              <span className="rounded-full bg-emerald-50 border border-emerald-200 px-3 py-1 text-xs text-emerald-800 font-mono-tech font-semibold">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-xs font-mono-tech">
              ...
              <div className="rounded-xl bg-slate-50 p-4 border border-slate-200">
                ...
                <div className="text-slate-700 space-y-1">
                  <div className="text-emerald-800 font-semibold">Sem restrições severas</div>
        ...
        {activeTab === 'diario' && (
          <div className="rounded-2xl border border-slate-200 bg-white p-6 sm:p-8 shadow-sm">
            <div className="flex justify-between items-center border-b border-slate-200 pb-4 mb-6">
              <div>
                <h3 className="text-lg font-bold text-slate-900">Feed do Diário Alimentar do Paciente</h3>
                <p className="text-xs text-slate-500 font-mono-tech mt-0.5">
                  Fotos sincronizadas em tempo real através do aplicativo móvel do paciente
                </p>
              </div>
              <span className="rounded bg-emerald-50 border border-emerald-200 text-emerald-800 px-2.5 py-1 text-xs font-mono-tech font-semibold">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="rounded-xl border border-slate-200 bg-slate-50/70 p-4">
                <div className="flex justify-between text-xs font-mono-tech mb-2">
                  ...
                  <span className="text-slate-500">07:45</span>
                </div>
                <div className="h-40 rounded-lg bg-white border border-slate-200 flex items-center justify-center text-slate-500 text-xs font-mono-tech">
                  [Foto do Prato: Ovos mexidos + Pão artesanal + Café]
                </div>
                <div className="mt-2 text-xs text-emerald-700 font-mono-tech flex items-center gap-1">
              ...
              <div className="rounded-xl border border-slate-200 bg-slate-50/70 p-4">
                <div className="flex justify-between text-xs font-mono-tech mb-2">
                  <span className="font-bold text-slate-800">Almoço</span>
                  <span className="text-slate-500">12:35</span>
                </div>
                <div className="h-40 rounded-lg bg-white border border-slate-200 flex items-center justify-center text-slate-500 text-xs font-mono-tech">
                ...
                <div className="mt-2 text-xs text-emerald-700 font-mono-tech flex items-center gap-1">
                  <CheckCircle2 className="h-3.5 w-3.5" />
                  <span>Prato equilibrado, sem adicionais</span>
                </div>
              </div>

              <div className="rounded-xl border border-slate-200 bg-slate-50/70 p-4">
                <div className="flex justify-between text-xs font-mono-tech mb-2">
                  <span className="font-bold text-slate-800">Lanche da Tarde</span>
                  <span className="text-slate-500">16:10</span>
                </div>
                <div className="h-40 rounded-lg bg-white border border-slate-200 flex items-center justify-center text-slate-500 text-xs font-mono-tech">
        ...
        {activeTab === 'agenda' && (
          <div className="rounded-2xl border border-slate-200 bg-white p-6 sm:p-8 shadow-sm">
            <div className="flex justify-between items-center border-b border-slate-200 pb-4 mb-6">
              <div>
                <h3 className="text-lg font-bold text-slate-900">Agenda & Automação WhatsApp Connect</h3>
                <p className="text-xs text-slate-500 font-mono-tech mt-0.5">
            ...
            <div className="space-y-3">
              {[
                ...
                <div
                  key={idx}
                  className="flex items-center justify-between p-3.5 rounded-xl bg-slate-50 border border-slate-200 text-xs font-mono-tech"
                >
                  <div className="flex items-center gap-4">
                    <span className="text-emerald-700 font-bold">{item.time}</span>
                    <div>
                      <strong className="text-slate-900 block">{item.patient}</strong>
                      <span className="text-slate-500 text-[10px]">{item.type}</span>
                    </div>
                  </div>
                  <span className="rounded bg-white border border-slate-200 px-2.5 py-1 text-[10px] text-slate-700 font-medium">
                    {item.status}
                  </span>
                </div>
              ))}
        ...
        {activeTab === 'financeiro' && (
          <div className="rounded-2xl border border-slate-200 bg-white p-6 sm:p-8 shadow-sm">
            <h3 className="text-lg font-bold text-slate-900 mb-2">Painel Financeiro do Consultório</h3>
            <p className="text-xs text-slate-500 font-mono-tech mb-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-6 font-mono-tech">
              <div className="rounded-xl bg-slate-50 p-4 border border-slate-200">
                <span className="text-[10px] text-slate-500 uppercase">Faturamento Este Mês</span>
                <div className="text-2xl font-bold text-slate-900 mt-1">R$ 18.450,00</div>
                <div className="text-[10px] text-emerald-700 font-semibold mt-1">41 consultas realizadas</div>
              </div>
              <div className="rounded-xl bg-slate-50 p-4 border border-slate-200">
                <span className="text-[10px] text-slate-500 uppercase">Ticket Médio / Consulta</span>
                <div className="text-2xl font-bold text-slate-900 mt-1">R$ 450,00</div>
                <div className="text-[10px] text-slate-500 mt-1">Com Dossiê 9pt + Scan 3D</div>
              </div>
              <div className="rounded-xl bg-slate-50 p-4 border border-slate-200">
                <span className="text-[10px] text-slate-500 uppercase">Previsão Próximo Mês</span>
                <div className="text-2xl font-bold text-slate-900 mt-1">R$ 22.000,00</div>
